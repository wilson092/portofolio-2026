...
class PesanPolicy
{
    ...
    {
        return $user->can('view_any_pesan');
    }
    ...
    {
        return $user->can('delete_any_pesan');
    }
     ...
     */
    public function replicate(User $user, Pesan $pesan): bool
    {
